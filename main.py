...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                             ...
                             QGridLayout, QMessageBox, QCheckBox, QComboBox,
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.preserve_structure_checkbox.setToolTip("Keep original folder structure or flatten all files to output directory")
