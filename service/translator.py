...
_translations: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "Select Unsupported Directory": "Выбрать папку неподдерживаемых файлов",
        "Unsupported files directory": "Папка для неподдерживаемых файлов",
        "Selected unsupported directory: {path}": "Выбрана папка неподдерживаемых файлов: {path}",
